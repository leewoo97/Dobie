...
public enum ErrorCode {
    ...
    DJANGO_BUILD_FAILED(HttpStatus.BAD_REQUEST, "Django 프로젝트 Dockerfile 생성에 실패했습니다."),
    ...
    DJANGO_FILE_PATH_NOT_EXIST(HttpStatus.NOT_FOUND, "명시하신 Django 경로는 존재하지 않는 경로입니다."),
    ...
    NGINX_CONF_NOT_FOUND(HttpStatus.BAD_REQUEST, "nginx config 파일 찾기를 실패했습니다."),
    SSL_CERTIFICATE_ISSUE_FAILED(HttpStatus.BAD_REQUEST, "ssl 인증서 발급 실패! 도메인을 확인해주세요"),
    SSL_LOG_DELETE_FAILED(HttpStatus.BAD_REQUEST, "ssl 인증서 발급 로그 삭제실패"),
